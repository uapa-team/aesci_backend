# Generated by Django 4.0.2 on 2022-02-23 03:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), null=True, size=2)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodPlan', models.CharField(choices=[('2021-2', '2021-2S'), ('2022-1', '2022-1S')], max_length=60)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codeMeasure', models.IntegerField(choices=[(1, 'Beginner'), (2, 'Apprentice'), (3, 'Competent'), (4, 'Expert')])),
                ('description', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignmentStudent', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='aesci_api.assignmentstudent')),
